...
@section('title', 'Conferma Cambio Password - OTP')
        ...
        <div class="col-md-6">
            <div class="card bg-transparent border-light">
                <div class="card-header text-center">
                    <h4><i class="fas fa-shield-alt me-2"></i>Conferma Cambio Password</h4>
                    <p class="mb-0 text-muted">Inserisci il codice di sicurezza per confermare il cambio password</p>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <!-- Form OTP -->
                    <form method="POST" action="{{ route('client.profile.confirm-password-change') }}" id="otpForm">
                        @csrf
                        
                        <div class="text-center mb-4">
                            <div class="alert alert-info">
                                <i class="fas fa-sms me-2"></i>
                                Abbiamo inviato un codice di sicurezza al tuo numero di telefono per confermare il cambio password.
                                @if($development_otp)
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-warning btn-lg" id="confirmBtn">
                                <i class="fas fa-key me-2"></i>Conferma Cambio Password
                            </button>
