        ...
        <div class="col-md-6">
            <div class="card bg-transparent border-light">
                <div class="card-header text-center">
                    ...
                    <p class="mb-0 text-muted">Inserisci il codice OTP per confermare il cambio password</p>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('client.profile.confirm-password-change') }}" id="otpForm">
                        ...
                        <div class="text-center mb-4">
                            <div class="alert alert-info">
                                ...
                                Abbiamo inviato un codice di sicurezza per confermare il cambio password.
                                @if($development_otp)
